...
public class TextureUtil {
    ...
    public static final IntBuffer dataBuffer = GLAllocationUtils.allocateIntBuffer(4194304);
    public static final int[] mipmapBuffer;
    public static final int[] dataArray = new int[4194304];
    ...
    public static void allocateTextureImpl(int p_180600_0_, int p_180600_1_, int p_180600_2_, int p_180600_3_) {
        ...
        for (int i = 0; i <= p_180600_1_; ++i) {
            GL11.glTexImage2D(GL11.GL_TEXTURE_2D, i, GL11.GL_RGBA, p_180600_2_ >> i, p_180600_3_ >> i, 0, GL12.GL_BGRA, GL12.GL_UNSIGNED_INT_8_8_8_8_REV, (double[]) null);
        }
    }
    ...
    public static void setTextureBlurMipmap(boolean p_147954_0_, boolean p_147954_1_) {
        if (p_147954_0_) {
            ...
            GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, p_147954_1_ ? 9986 : GL11.GL_NEAREST);
