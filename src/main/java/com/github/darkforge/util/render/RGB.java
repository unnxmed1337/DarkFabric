...
public class RGB {
    ...
    public RGB(int color) {
        ...
        this((color >> 16 & 255) / 255f, (color >> 8 & 255) / 255f, (color & 255) / 255f, (color >> 24 & 255) / 255f);
    }

    public RGB setR(float r) {

        this.r = MathHelper.clamp(r, 0f, 1f);
        return this;
    }

    public RGB setG(float g) {

        this.g = MathHelper.clamp(g, 0f, 1f);
        return this;
    }

    public RGB setB(float b) {
    ...
    public void set(int color) {
        ...
        set((color >> 16 & 255) / 255f, (color >> 8 & 255) / 255f, (color & 255) / 255f, (color >> 24 & 255) / 255f);
    }
    ...
    public RGB blend(RGB rgb, float ratio) {
        ...
        return new RGB((r * iRatio) + (rgb.r * ratio), (g * iRatio) + (rgb.g * ratio), (b * iRatio) + (rgb.b * ratio), (a * iRatio) + (rgb.a * ratio));
    }
